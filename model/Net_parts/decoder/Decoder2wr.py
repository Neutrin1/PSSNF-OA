...
from PSSNF.model.Net_parts.public.TUAN import UNetLDBwr  # 导入标准UNet解码器块

class Decoder2wr(nn.Module):
    def __init__(self, num_classes=1, base_channels=32, block=UNetLDBwr, kernel_size=7, use_bn=True):
        super().__init__()

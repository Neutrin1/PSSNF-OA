...
from PSSNF.model.Net_parts.public.SKNets import SKAttention
class Encoder5(nn.Module):
    def __init__(self, in_channels, base_channels=32, b1= UNetFirstEB, b2=ParallelConvRDLEBEncoderBlock, use_bn=True):
        ...
        self.sk1 = SKAttention(channel=32)
        self.sk2 = SKAttention(channel=64)
        self.sk3 = SKAttention(channel=128)
        self.sk4 = SKAttention(channel=256)
